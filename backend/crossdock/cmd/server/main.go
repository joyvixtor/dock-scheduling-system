...
import (
	...
	"github.com/joyvixtor/dock-scheduling-system/backend/crossdock/internal/delivery/graphql/resolvers"
	httpclient "github.com/joyvixtor/dock-scheduling-system/backend/crossdock/internal/repository/httpclient"
	pgrepo "github.com/joyvixtor/dock-scheduling-system/backend/crossdock/internal/repository/postgres"
	"github.com/joyvixtor/dock-scheduling-system/backend/crossdock/internal/usecase"
)
...
func main() {
	...
	router.Handle("/", playground.Handler("crossdock GraphQL playground", "/query"))
	...
	log.Printf("crossdock subgraph listening on %s", server.Addr)
